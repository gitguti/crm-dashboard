...
export const Stat = ({ symbol, concept, number, detail, badgeColor }) => {
  return (
    ...
    >
      ...
      <Text color="neutrals.gray.steel" fontWeight="regular" fontSize="0.9rem">
        {concept}
      </Text>
      <Stack direction="row" alignItems="baseline">
        <Text fontWeight="regular" color="neutrals.gray.steel" fontSize="1.2rem">
          {number}
        </Text>
        <Text fontWeight="regular" color="neutrals.gray.ash" fontSize="0.7rem">
          {detail}
        </Text>
      </Stack>
    </Flex>
